...
let trades: Trade[] = [
  ...
  { id: '2', pair: 'GBPJPY', type: 'sell', profit: -40, riskRewardRatio: -1, closeDate: new Date('2023-10-26T12:30:00Z'), strategy: 'Day Trading', session: 'London', outcome: 'sl' },
  { id: '3', pair: 'EURUSD', type: 'buy', profit: 150, riskRewardRatio: 1.5, closeDate: new Date('2023-10-27T08:45:00Z'), strategy: 'Swing Trading', session: 'New York', outcome: 'cp' },
  { id: '4', pair: 'XAUUSD', type: 'sell', profit: -100, riskRewardRatio: -0.5, closeDate: new Date('2023-10-27T14:00:00Z'), strategy: 'Scalping', session: 'New York', outcome: 'cl' },
  { id: '5', pair: 'GBPJPY', type: 'buy', profit: 0, riskRewardRatio: 0, closeDate: new Date('2023-10-28T11:00:00Z'), strategy: 'Position Trading', session: 'Asian', outcome: 'breakeven' },
